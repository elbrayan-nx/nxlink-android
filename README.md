...
1. Descarga e instala el APK en tu Android (ver sección de Releases)
2. En tu Android, abre la app **NXLink**
3. Toca **Browse** y selecciona el archivo `.nro` que quieres enviar
4. En tu Nintendo Switch, abre el **Homebrew Menu** y presiona **Y** para activar el Netloader
5. El Switch mostrará su dirección IP en pantalla (ejemplo: `192.168.1.21`)
6. Ingresa esa IP en la app y toca **"Send to Switch"**
7. ¡El archivo se transfiere y se abre automáticamente en el Switch! ✅
...
👉 Ve a la sección [Releases](../../releases) y descarga el archivo `app-debug.apk`
...
Protocolo basado en [nx-hbmenu](https://github.com/switchbrew/nx-hbmenu) de Switchbrew.
